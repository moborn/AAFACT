...
if better_start == 2
    field_name = fields{1};
    [R_temp,T_temp,E_temp] = icp(nodes_template',nodes', iterations,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp,'Minimize','plane');
    [Rwr_temp,Twr_temp,Ewr_temp] = icp(nodes_template',nodes', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
...
if better_start == 1
    ...
    for n = 1:numel(fields)
        ...
        [~,~,error_temp] = icp(nodes_template',rotnodes', iterations_temp,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp,'Minimize','plane'); % Perform small ICP
    ...
    for i = 1:numel(smallest_fields)
        ...
        [R_temp,T_temp,E_temp] = icp(nodes_template',rotnodes', iterations,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp,'Minimize','plane');
        [Rwr_temp,Twr_temp,Ewr_temp] = icp(nodes_template',rotnodes', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
        if E_temp(end) < Ewr_temp(end)
            R.(field_name) = R_temp;
            T.(field_name) = T_temp;
            E.(field_name) = E_temp(end);
...
if bone_indx == 1 && bone_coord >= 2
    [sR_talus,~,~] = icp(nodes_template2',nodes_template',25,'Matching','kDtree','EdgeRejection',logical(1),'Triangulation',con_temp,'Minimize','plane');
...
if (tibfib_switch == 1 && bone_indx == 13) || (tibfib_switch == 1 && bone_indx == 14)
    ...
    [Rtw1,Ttw1,Etw1] = icp(nodes_template',nodes_test1', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
    
    if better_start == 1
        [Rtw2,Ttw2,Etw2] = icp(nodes_template',nodes_test2', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
        [Rtw3,Ttw3,Etw3] = icp(nodes_template',nodes_test3', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
        [Rtw4,Ttw4,Etw4] = icp(nodes_template',nodes_test4', iterations,'Matching','kDtree','WorstRejection',0.1,'Minimize','plane');
